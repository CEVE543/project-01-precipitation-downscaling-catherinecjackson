...
default_value = 0.0 # <1>
filled_precip_tx_p = coalesce.(precip_tx_p, default_value)
```
...
default_value = 0.0 # <1>
fill_precip_tx_p = coalesce.(precip_tx_p, default_value) # <2>
oneslice = fill_precip_tx_p[:,:,randomtime]
plot()
for i = 1:13
    t0 = 0
    fs = 24-1
...
stoch_precip_tx_p = fill_precip_tx_p[:, :, randomtimestep] # <2>
slope = 1;
nf = 5;
