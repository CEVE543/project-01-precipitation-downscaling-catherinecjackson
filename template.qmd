...
plot!(sur1, sur2, layout = (1, 2), legend = true)
```
...
plot(emptyquantiletrack[1, :], label = "25th Percentile")
plot!(emptyquantiletrack[2, :], label = "50th Percentile")
plot!(emptyquantiletrack[3, :], label = "75th Percentile")
```
