...
``` {julia}
# Latitude and Longitude of the Precipitation File
lat_range = precip_tx["lat"][:]
lon_range = precip_tx["lon"][:]
temp_2015 = temp_2015["t2m"]
temp_2016 = temp_2016["t2m"]
temp_2017 = temp_2017["t2m"]
temp_2018 = temp_2018["t2m"]
temp_2019 = temp_2019["t2m"]
temp_2020 = temp_2020["t2m"]
```
...
```{julia}
using RainFARM
# use rainfarm to downscale the precipitation data
r = precip_tx["precip"]
slope = 1;
nf = 5;
